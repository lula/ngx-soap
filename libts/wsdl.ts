...
var NSContext = require('./nscontext');
// var fs = require('fs');
var url = require('url');
...
var ElementElement = createSubClass();
var AnyElement = createSubClass();
var InputElement = createSubClass();
var OutputElement = createSubClass();
var SimpleTypeElement = createSubClass();
var RestrictionElement = createSubClass();
var ExtensionElement = createSubClass();
var ChoiceElement = createSubClass();
var EnumerationElement = createSubClass();
var ComplexTypeElement = createSubClass();
var ComplexContentElement = createSubClass();
var SimpleContentElement = createSubClass();
var SequenceElement = createSubClass();
var AllElement = createSubClass();
var MessageElement = createSubClass();
var DocumentationElement = createSubClass();
var SchemaElement: any = createSubClass();
var TypesElement: any = createSubClass();
var OperationElement = createSubClass();
var PortTypeElement = createSubClass();
var BindingElement = createSubClass();
var PortElement = createSubClass();
var ServiceElement = createSubClass();
var DefinitionsElement: any = createSubClass();
...
var ElementTypeMap = {
  ...
  fault: [WSDLElement, '_fault documentation'],
...
function mapElementTypes(types) {
  ...
  types.forEach(function(type) {
    rtn[type.replace(/^_/, '')] = (ElementTypeMap[type] || [WSDLElement]) [0];
  });
  return rtn;
}
 ...
 * @param {NSContext} nsContext Namespace context
 */
...
function open_wsdl(uri, options, callback) {
  ...
  if (!/^https?:/.test(uri)) {
    ...
    callback("Files are not supported")
