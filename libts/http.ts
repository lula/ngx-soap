 ...
 * @constructor
 */
function HttpClientInt(options) {
  options = options || {};
 ...
 */
HttpClientInt.prototype.buildRequest = function(rurl, data, exheaders, exoptions) {
 ...
 */
HttpClientInt.prototype.handleResponse = function(req, res, body) {
...
HttpClientInt.prototype.request = function(rurl, data, callback, exheaders, exoptions) {
  var self = this;
...
HttpClientInt.prototype.requestStream = function(rurl, data, exheaders, exoptions) {
  var self = this;
  var options = self.buildRequest(rurl, data, exheaders, exoptions);
  return self._request(options);
};

module.exports = HttpClientInt;
