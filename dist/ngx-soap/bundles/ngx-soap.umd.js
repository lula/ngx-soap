(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('sax'), require('url'), require('assert'), require('lodash'), require('crypto-js/sha1'), require('crypto-js/enc-base64'), require('buffer'), require('events'), require('util'), require('uuid/v4'), require('rxjs'), require('rxjs/operators'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('ngx-soap', ['exports', '@angular/core', 'sax', 'url', 'assert', 'lodash', 'crypto-js/sha1', 'crypto-js/enc-base64', 'buffer', 'events', 'util', 'uuid/v4', 'rxjs', 'rxjs/operators', '@angular/common/http'], factory) :
    (global = global || self, factory(global['ngx-soap'] = {}, global.ng.core, global.sax, global.url, global.assert, global.lodash, global.sha1, global.Base64, global.buffer, global.events, global.util, global.uuid4, global.rxjs, global.rxjs.operators, global.ng.common.http));
}(this, (function (exports, core, sax, url, assert, lodash, sha1, Base64, buffer, events, util, uuid4, rxjs, operators, http) { 'use strict';
