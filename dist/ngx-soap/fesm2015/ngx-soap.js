 ...
 */
const findPrefix = function (xmlnsMapping, nsURI) {
...
WSDL.prototype._parse = function (xml) {
    let self = this, p = parser(true), stack = [], root = null, types = null, schema = null, options = self.options;
    p.onopentag = function (node) {
        let nsName = node.name;
        let attrs = node.attributes;
        let top = stack[stack.length - 1];
...
/** @nocollapse */ NgxSoapService.ɵfac = function NgxSoapService_Factory(t) { return new (t || NgxSoapService)(ɵɵinject(HttpClient)); };
/** @nocollapse */ NgxSoapService.ɵprov = ɵɵdefineInjectable({ token: NgxSoapService, factory: NgxSoapService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { ɵsetClassMetadata(NgxSoapService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
/** @nocollapse */ NgxSoapModule.ɵmod = ɵɵdefineNgModule({ type: NgxSoapModule });
/** @nocollapse */ NgxSoapModule.ɵinj = ɵɵdefineInjector({ factory: function NgxSoapModule_Factory(t) { return new (t || NgxSoapModule)(); }, imports: [[
            HttpClientModule
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(NgxSoapModule, { imports: [HttpClientModule] }); })();
/*@__PURE__*/ (function () { ɵsetClassMetadata(NgxSoapModule, [{
        type: NgModule,
        args: [{
                imports: [
                    HttpClientModule
